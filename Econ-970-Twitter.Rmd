...
# can probably renove this part of the analysis -- don't need word frequency graphs for each company
...
ipo.2021$mean_hashtags <- 0
ipo.2021$mean_tags <- 0

# for loop for each company in the ipo2021 data set

for (i in 1:nrow(ipo.2021)) {
